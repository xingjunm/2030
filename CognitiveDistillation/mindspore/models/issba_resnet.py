...
from mindspore.common.initializer import Normal, HeNormal, Constant
import numpy as np
...
class ResNet18_200(nn.Cell):
    def __init__(self, num_classes=200):
        super(ResNet18_200, self).__init__()
        self.model = resnet18()
        # Replace the final fc layer with the correct number of classes
        in_features = self.model.fc.in_channels
        self.model.fc = nn.Dense(in_features, num_classes)
