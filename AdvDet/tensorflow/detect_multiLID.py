...
def main(args):
    ...
    # RISK_INFO: [API 行为不等价] - The behavior of classifier.predict might differ between frameworks (e.g., return type, performance on GPU), potentially affecting downstream numpy operations.
