"""
KDE (Kernel Density Estimation) detection method for TensorFlow
Reference: Feinman et al. "Detecting adversarial samples from artifacts" (2017)
"""
...
# RISK_INFO: [API 行为不等价] - The original code implicitly imports roc_curve and auc from common.util, while the new code imports them directly from sklearn.metrics. This could lead to different behavior if common.util provides a custom or different implementation.
...
def main(args):
    ...
    # Load the dataset - use uppercase variable names as in original
    ...
    X_test_normal_features_file = '{}{}_dens_normal.npy'.format(kde_results_dir, args.dataset)
