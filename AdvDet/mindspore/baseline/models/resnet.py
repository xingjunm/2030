...
class BasicBlock(nn.Cell):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.conv1 = nn.Conv2d(
            in_planes, planes, kernel_size=3, stride=stride, padding=1, pad_mode='pad', has_bias=False)
...
class Bottleneck(nn.Cell):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.conv3 = nn.Conv2d(planes, self.expansion *
                               planes, kernel_size=1, has_bias=False)
...
def test():
    net = ResNet18()
    y = net(Tensor(np.random.randn(1, 3, 32, 32), mindspore.float32))
    print(y.shape)
