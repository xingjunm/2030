...
def main(args):
    ...
    if args.dataset == 'mnist':
        ...
        model_mnist = model(mode='load', filename='cnn_{}.ckpt'.format(args.dataset))
        ...
        model_cifar = model(mode='load', filename='cnn_{}.ckpt'.format(args.dataset))
        ...
        model_svhn = model(filename='cnn_{}.ckpt'.format(args.dataset))
        ...
        model_imagenet = model(filename='cnn_{}.ckpt'.format(args.dataset))
    ...
    if args.dataset != 'mnist':
        # AdversarialPatchPyTorch is PyTorch-specific and no MindSpore equivalent exists
        # Skipping this attack for MindSpore implementation
