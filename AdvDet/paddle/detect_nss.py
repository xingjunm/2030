...
def main(args):
    ...
    # RISK_INFO: [API 行为不等价] - 'classifier.predict' is an abstraction over the underlying ML framework. Its behavior (e.g., output dtype, value range) might differ from the original implementation, affecting subsequent operations like argmax.
