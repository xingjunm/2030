...
def main(args):
    ...
    if args.dataset == 'mnist':
        ...
        model_mnist = model(mode='load', filename='cnn_{}.pdparams'.format(args.dataset))
        ...
        model_cifar = model(mode='load', filename='cnn_{}.pdparams'.format(args.dataset))
        ...
        model_svhn = model(mode='load', filename='cnn_{}.pdparams'.format(args.dataset))
        ...
        model_imagenet = model(filename='cnn_{}.pdparams'.format(args.dataset))
    ...
    if args.dataset != 'mnist':
        # AdversarialPatchPyTorch is PyTorch-specific and no PaddlePaddle equivalent exists
        # Skipping this attack for PaddlePaddle implementation
