...
def main(args):
    ...
    # RISK_INFO: [API 行为不等价] - The 'classifier.predict' method is framework-dependent. The PaddlePaddle implementation may have subtle differences in output values, precision, or batch processing compared to the original framework's implementation, potentially affecting downstream calculations.
