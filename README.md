...
- BlueSuffix - [PyTorch](BlueSuffix/pytorch)
...
- **BlueSuffix** (`BlueSuffix/`): A universal defense method against jailbreak attack on Vision-Language Models. Framework entry points: [PyTorch](BlueSuffix/pytorch)
