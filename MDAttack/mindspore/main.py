...
# Import MindSpore version of Attacker
...
def main():
    ...
    # Use PyTorch DatasetGenerator for compatibility with PyTorch models
    ...
    if args.attack == 'AA':
        ...
        # Use MindSpore version of Attacker
        # The MindSpore Attacker handles PyTorch model wrapping internally
